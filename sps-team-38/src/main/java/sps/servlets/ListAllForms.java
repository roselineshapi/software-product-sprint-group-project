...
public class ListAllForms extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    for (Entity entity : results.asIterable()) {
      ...
      Form form = new Form (id , timestamp, title, ownerName, ownerEmail, description, sessionUrl, expiryDate, capacity);
      forms.add(form);
    }
  ...
  @Override
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String onwerName = request.getParameter("ownerName");
        String onwerEmail = request.getParameter("ownerEmail");
